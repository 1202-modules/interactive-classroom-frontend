...
export function useWorkspaceSessions(workspaceId: number) {
    ...
    const fetchSessions = useCallback(async () => {
        ...
        try {
            ...
            setError(parseBackendError(err?.response?.data, 'Failed to load sessions'));
        } finally {
    ...
    const moveSession = async (sessionId: number, next: SessionStatus) => {
        ...
        try {
            ...
            setError(parseBackendError(err?.response?.data, 'Failed to change session status'));
    ...
    const toggleStartStop = async (sessionId: number) => {
        ...
        try {
            ...
            setError(parseBackendError(err?.response?.data, 'Failed to change session state'));
            setSessions(previous);
        } finally {
            setUpdatingSessionId(null);
        }
    ...
    const restoreSession = async (sessionId: number) => {
        ...
        try {
            ...
            setError(parseBackendError(err?.response?.data, 'Failed to restore session'));
            setSessions(previous);
        } finally {
            setUpdatingSessionId(null);
        }
    ...
    const deleteSessionPermanently = async (sessionId: number) => {
        ...
        try {
            ...
            setError(parseBackendError(err?.response?.data, 'Failed to delete session permanently'));
            setSessions(previous);
        } finally {
            setUpdatingSessionId(null);
        }
