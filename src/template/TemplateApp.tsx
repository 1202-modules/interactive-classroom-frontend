    ...
    <ThemeProvider theme={theme}>
      <Layout theme={theme} onToggleTheme={toggleTheme}>
        <Routes>
          ...
          <Route path="/workspace/:workspaceId/session/:sessionId/presentation" element={<PresentationPage />} />
          <Route path="/workspace/:workspaceId/session/:sessionId" element={<SessionPage />} />
