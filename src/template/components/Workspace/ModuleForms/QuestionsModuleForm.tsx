      ...
      <div className="workspace-page__module-form-grid">
        <div className="workspace-page__module-form-field">
          <Switch
            ...
            content="Allow anonymous questions"
            size="l"
          />
          <Text variant="body-2" color="secondary">
            Anonymous users can submit questions without logging in.
          </Text>
        </div>
        <div className="workspace-page__module-form-field">
          <Switch checked={enableUpvotes} onUpdate={onEnableUpvotesChange} content="Enable upvotes" size="l" />
          <Text variant="body-2" color="secondary">
