    ...
    <div className="workspace-page__module-form">
      <div className="workspace-page__module-form-grid">
        <div className="workspace-page__module-form-field">
          ...
          <TextInput value={name} onUpdate={onNameChange} size="l" placeholder="Module name" />
        </div>
        ...
        <div className="workspace-page__module-form-field">
          ...
          <Switch checked={enabled} onUpdate={onEnabledChange} content="Enable this module" size="l" />
        </div>
      </div>
