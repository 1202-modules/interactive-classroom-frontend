import { Button, Divider, Icon, RadioGroup, Switch, Text, TextArea, TextInput } from '@gravity-ui/uikit';
  ...
  return (
    <div className="workspace-page__module-form">
      ...
      <div className="workspace-page__module-form-field">
        ...
        <TextArea value={question} onUpdate={onQuestionChange} size="l" rows={3} placeholder="Ask a question…" />
      </div>
      ...
      <div className="workspace-page__module-form-grid">
        ...
        <div className="workspace-page__module-form-field">
          ...
          <Switch checked={wordCloud} onUpdate={onWordCloudChange} content="Word cloud" size="l" />
        </div>
      </div>
