  ...
  return (
    <div className="workspace-page__module-form">
      ...
      <div className="workspace-page__module-form-grid">
        ...
        <div className="workspace-page__module-form-field">
          <Switch checked={enableSound} onUpdate={onEnableSoundChange} content="Enable sound" size="l" />
          <Text variant="body-2" color="secondary">
      ...
      <div className="workspace-page__module-form-field">
        <Switch checked={allowPause} onUpdate={onAllowPauseChange} content="Allow pause/resume" size="l" />
        <Text variant="body-2" color="secondary">
