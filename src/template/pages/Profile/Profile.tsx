          ...
          <div className="profile-page__card-content">
            ...
            <div className="profile-page__name-password-row">
              <div className="profile-page__name-column">
                ...
                {/* Save Button */}
                <div className="profile-page__field">
                  <Button view="action" size="l" className="profile-page__save-button">
                    Save
                  </Button>
                </div>
              </div>
              ...
              <div className="profile-page__password-column">
                ...
                <div className="profile-page__field profile-page__change-password-field">
                  <Button view="outlined" size="l" className="profile-page__change-password-button">
            ...
            <div className="profile-page__field">
              ...
              />
              {timezone === 'manual' && (
                <div className="profile-page__field" style={{ marginTop: 'var(--g-spacing-3)' }}>
                  <Select
          ...
          <div className="profile-page__card-content">
            <div className="profile-page__field">
              ...
              <div style={{ marginTop: 'var(--g-spacing-3)' }}>
                <Button view="outlined-danger" size="l" onClick={handleDeleteAccount}>
