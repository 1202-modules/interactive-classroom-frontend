  ...
  return (
    <div className="settings-page">
      <div className="settings-page__header">
        <Text variant="display-1">Application Settings</Text>
      </div>
        ...
        <Card view="outlined" className="settings-page__card">
          ...
          <div className="settings-page__card-content">
            <div className="settings-page__field">
              ...
              <RadioGroup
                value={theme}
                onUpdate={(value: string) => setTheme(value as 'light' | 'dark' | 'auto')}
                options={[
              ...
              <div className="settings-page__switch-field">
                <div className="settings-page__switch-label-row">
                  ...
                  <Label 
                    theme="warning" 
                    size="s" 
                    className="settings-page__wip-label"
                    title="Work In Progress - This feature is currently under development"
                  >
                    <span className="settings-page__wip-icon-wrapper">
          ...
          <div className="settings-page__card-content">
            <div className="settings-page__field">
              <div className="settings-page__label-row">
                ...
                <Label theme="warning" size="s" className="settings-page__wip-label">
                  <span className="settings-page__wip-icon-wrapper">
                    <Icon data={Clock} size={14} />
                  </span>
                  <span>WIP</span>
          ...
          <div className="settings-page__card-content">
            <div className="settings-page__field">
              <div className="settings-page__switch-field">
                ...
                <Text variant="body-2" color="secondary">
                  Allow tracking of how you use the application to improve features.
                </Text>
              </div>
            </div>
